...
Cada exercício aborda um problema simples e apresenta, de forma incremental, conceitos importantes da linguagem Python.
...
| [Exercício 04 - Verificador de Senha](verifica-senha.py) | Verifica se uma senha possui pelo menos oito caracteres, uma letra maiúscula e um número. | Laços de repetição, condicionais, valores booleanos e métodos de string |
